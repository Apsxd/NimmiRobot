...
import Nimmirobot.modules.sql.connection_sql as sql
from Nimmirobot import dispatcher, DRAGONS, DEV_USERS
from Nimmirobot.modules.helper_funcs import chat_status
...
*ADMIN COMMAND:*
 • `/allowconnection <yes/no>`: allow a user to connect to a chat
"""
