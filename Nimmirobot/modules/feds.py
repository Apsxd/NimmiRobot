...
import Nimmirobot.modules.sql.feds_sql as sql
...
from Nimmirobot.modules.helper_funcs.string_handling import markdown_parser
...
just kanged feds.py from @saitamarobot 
developed by @swada and team
for support @tubots
"""
