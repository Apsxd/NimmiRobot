...
import Nimmirobot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from Nimmirobot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
from Nimmirobot.modules.log_channel import gloggable
...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "Nimmirobot":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot allows Nimmi to talk and provides a more interactive group chat experience.
