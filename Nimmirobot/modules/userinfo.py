...
import Nimmirobot.modules.sql.userinfo_sql as sql
...
from Nimmirobot.modules.sql.afk_sql import is_afk, check_afk_status
...
def info(update: Update, context: CallbackContext):
    ...
    #     text += ' [<a href="https://t.me/nimmisupport/155">?</a>]'.format(
    #         bot.username)
