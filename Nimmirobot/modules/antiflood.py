...
from Nimmirobot.modules.sql import antiflood_sql as sql
...
from Nimmirobot.modules.helper_funcs.alternate import send_message
...
__help__ = """
Antiflood in nimmi allows you to take action on users that send more than x messages in a row. Exceeding the set flood \
