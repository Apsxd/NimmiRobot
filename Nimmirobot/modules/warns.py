...
import telegram
from Nimmirobot import WOLVES, dispatcher
...
from Nimmirobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Nimmirobot.modules.helper_funcs.string_handling import split_quotes
from Nimmirobot.modules.log_channel import loggable
from Nimmirobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Nimmirobot's sticker
        keyboard = None
        log_reason = (
