...
import Nimmirobot.modules.sql.notes_sql as sql
from Nimmirobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Nimmirobot.__main__ import DATA_IMPORT
from Nimmirobot.modules.helper_funcs.chat_status import user_admin
from Nimmirobot.modules.helper_funcs.alternate import typing_action

# from Nimmirobot.modules.rules import get_rules
import Nimmirobot.modules.sql.rules_sql as rulessql

# from Nimmirobot.modules.sql import warns_sql as warnssql
import Nimmirobot.modules.sql.blacklist_sql as blacklistsql
from Nimmirobot.modules.sql import disable_sql as disabledsql

# from Nimmirobot.modules.sql import cust_filters_sql as filtersql
# import Nimmirobot.modules.sql.welcome_sql as welcsql
import Nimmirobot.modules.sql.locks_sql as locksql
from Nimmirobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Nimmirobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Nimmirobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("Nimmirobot{}.backup".format(chat_id))  # Cleaning file
